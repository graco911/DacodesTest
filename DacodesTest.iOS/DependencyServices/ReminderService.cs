...
using DacodesTest.iOS.Helpers;
using Xamarin.Forms;
using DacodesTest.iOS.DependencyServices;

[assembly: Dependency(typeof(ReminderService))]
namespace DacodesTest.iOS.DependencyServices
{
    public class ReminderService : IReminderService
    {
        ...
        public void EnsureInvokedOnMainThread(Action action)
        {
